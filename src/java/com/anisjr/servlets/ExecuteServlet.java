...
public class ExecuteServlet extends HttpServlet {
	...
	de.cynapsys.homeautomation.webservice.Device resultDevice = portDevice.getDeviceByID(valueOf(request.getParameter("deviceID")));
        portDevice.setValue(valueOf(request.getParameter("deviceID")),Math.abs(resultDevice.getCurrentValue()-100));
