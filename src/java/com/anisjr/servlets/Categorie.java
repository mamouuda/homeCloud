...
public class Categorie extends HttpServlet {
	...
	// TODO process result here
	de.cynapsys.homeautomation.webservice.CategoryArray resultCategory = portCategory.getAllCategories();
        request.setAttribute("resultCategory", resultCategory);
       
        
       }catch(Exception ex){}
              this.getServletContext().getRequestDispatcher("/WEB-INF/user/categorie.jsp").forward(request, response);
    }
