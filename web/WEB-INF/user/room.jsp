...
<%@page import="de.cynapsys.homeautomation.webserviceimpl.RoomWebService"%>
...
<html lang="en">
    ...
    <body>
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            <h1 class="page-header"><%  out.print(request.getAttribute("nameRoom")); %>  ${ !empty id ? id : '' }</h1>
            ...
            <div class="row placeholders">
                ...
                <div class="col-xs-6 col-sm-3 placeholder">
                    ...
                    <img class="img-responsive" alt="200x200" src="/images/<%  out.print(Utils.Utils.resolveImageName(request.getAttribute("nameRoom").toString())); %>" data-holder-rendered="true">
                    <h4><%  out.print(request.getAttribute("nameRoom")); %></h4>
                </div>
